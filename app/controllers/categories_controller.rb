class CategoriesController < ApplicationController
  ...
  def create
    ...
    if the_category.valid?
      ...
      redirect_to("/categories", { :notice => "Category failed to create successfully." })
    end
  end
  ...
  def update
    ...
    if the_category.valid?
      ...
      redirect_to("/categories/#{the_category.id}", { :alert => "Category failed to update successfully." })
    end
  end
